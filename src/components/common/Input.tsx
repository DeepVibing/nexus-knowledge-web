      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <input
            ...
            id={inputId}
            className={cn(
              'w-full px-4 py-2 bg-[#141414] border border-[#2A2A2A] rounded text-[#F5F5F5] placeholder-[#666666]',
          ...
          />
          {rightIcon && (
            <div className="absolute inset-y-0 right-0 pr-3 flex items-center text-[#666666]">
              {rightIcon}
            </div>
          )}
        </div>
